  ...
  return (
    <div className="animate-fade-in space-y-24 py-10 pt-[64px]">
      ...
      <section className="text-center max-w-4xl mx-auto mb-12">
        <div className="bg-base-200 rounded-3xl p-8 border-2" style={{ border: '2px solid #a3a3a3', boxShadow: '0 4px 24px 0 rgba(0,0,0,0.18)' }}>
      ...
      <section className="text-center max-w-2xl mx-auto mt-10">
        <div className="bg-base-200 rounded-3xl p-6 border-2" style={{ border: '2px solid #a3a3a3', boxShadow: '0 4px 24px 0 rgba(0,0,0,0.18)' }}>
          <h2 className="text-2xl font-bold mb-2">Creators</h2>
          <p className="text-lg text-neutral/80">Arun M &amp; Aditya B M</p>
        </div>
      </section>

      {/* Project Overview & Objectives Section */}
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
        <div className="bg-base-200 rounded-3xl p-8 border-2 flex flex-col justify-center" style={{ border: '2px solid #a3a3a3', boxShadow: '0 4px 24px 0 rgba(0,0,0,0.18)' }}>
      ...
      <section className="py-12">
        ...
        <Slider {...sliderSettings}>
          ...
          <div className="p-3">
            <FeatureCard title="Predictive AI" icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6l4 2" /></svg>}>
              AI predicts when an excuse might be needed based on past patterns.
            </FeatureCard>
          </div>
          <div className="p-3">
            <FeatureCard title="Effectiveness Ranking" icon={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>}>
